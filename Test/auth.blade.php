...
<body class="gradient-bg min-h-screen flex items-center justify-center p-4">
    ...
    <div class="max-w-4xl w-full flex rounded-xl shadow-2xl overflow-hidden">
        <!-- Form Container -->
        <div class="w-full md:w-1/2 glass-effect p-8 form-container" id="formContainer">
            <!-- Login Form -->
            <div id="loginForm">
...
<i class="far fa-envelope"></i>
                ...
                <p class="mt-6 text-center text-sm text-gray-600">
                    Chưa có tài khoản? 
                    <a href="#" class="text-blue-600 hover:text-blue-800 hover:underline font-medium" id="showRegisterForm">
                        Đăng ký ngay
                    </a>
                </p>
            </div>
